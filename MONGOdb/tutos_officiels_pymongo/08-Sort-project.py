# https://learn.mongodb.com/learn/course/mongodb-aggregation-in-python/lesson-3-using-mongodb-aggregation-stages-with-python-sort-and-project/learn?client=customer&page=2
